...
from utils.utils import make_env, reset_nn_layers
...
def parse_args():
    ...
    parser.add_argument("--reset_nn_freq", type=int, default=50_000)
        ...
        if global_step > args.learning_start and not(global_step % args.train_freq):
            for _ in range(args.gradient_steps):
                ...
                if time_to_reset:
                    ...
                    reset_nn_layers(target.critic_net1)
                    reset_nn_layers(target.critic_net2)
